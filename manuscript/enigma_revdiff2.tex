...
%DIF ADD enigma_rev5.tex   Wed Jun 10 15:21:42 2020
%DIF 2-7c2
...
\begin{abstract}
  \DIFaddbegin \noindent \textbf{\DIFadd{Abstract}}\\ %DIF > 164
...
\DIFaddbegin \begin{figure*}[h!]
  ...
  }\textbf{\DIFaddFL{a}}\DIFaddFL{, Structural nestedness of communities, measured as UNODF (Unipartite Nestedness based on Overlap and Decreasing Fill; measured using the R package UNODF v.1.2) \mbox{%DIFAUXCMD
\cite{Cantor2017}}\hspace{0pt}%DIFAUXCMD
.
  The value reported is the mean value taken across the rows and columns of the adjacency matrix accounting for both trophic and service interactions.
  %DIF >  Inset: A trophic and mutualistic nested motif for resource species 1, 2 and consumer species 3, 4.
...
\DIFdelbegin %DIFDELCMD < \bibitem{Odum1969}
...
\DIFdelbegin %DIFDELCMD < \bibitem{Lawton1994}
...
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \bibitem{Odum1969}
\bibinfo{author}{Odum, E.~P.}
\DIFaddend \newblock \DIFdelbegin %DIFDELCMD < \bibinfo{title}{{Niche construction theory: a practical guide for
%DIFDELCMD <   ecologists.}}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \bibinfo{title}{The strategy of ecosystem development}\DIFadd{.
}\DIFaddend \newblock \emph{\DIFdelbegin %DIFDELCMD < \bibinfo{journal}{Q. Rev. Biol.}%%%
\DIFdelend \DIFaddbegin \bibinfo{journal}{Science}\DIFaddend } \textbf{\DIFdelbegin %DIFDELCMD < \bibinfo{volume}{88}}%%%
...
\DIFdel{,
  }%DIFDELCMD < \bibinfo{author}{Laland, K.} %%%
\DIFdel{\&
...
\DIFdel{, }%DIFDELCMD < \bibinfo{year}{2013}%%%
\DIFdelend \DIFaddbegin \bibinfo{volume}{164}}\DIFadd{,
  }\bibinfo{pages}{262--270} \DIFadd{(}\bibinfo{year}{1969}\DIFaddend ).
...
\DIFaddbegin \bibitem{OdlingSmee2013}
\bibinfo{author}{Odling-Smee, J.}\DIFadd{, }\bibinfo{author}{Erwin, D.~H.}\DIFadd{,
  }\bibinfo{author}{Palkovacs, E.~P.}\DIFadd{, }\bibinfo{author}{Feldman, M.~W.} \DIFadd{\&
...
\newblock \emph{\bibinfo{journal}{Q. Rev. Biol.}}
  \textbf{\bibinfo{volume}{88}}\DIFadd{, }\bibinfo{pages}{4--28} \DIFadd{(}\bibinfo{year}{2013}\DIFadd{).
}

\DIFaddend \bibitem{Leuthold1996}
...
\DIFdelbegin %DIFDELCMD < \bibitem{Cantor2017}
...
\DIFaddbegin \bibitem{Lawton1994}
\bibinfo{author}{Lawton, J.~H.}
\newblock \bibinfo{title}{What do species do in ecosystems?}
\newblock \emph{\bibinfo{journal}{Oikos}} \textbf{\bibinfo{volume}{71}}\DIFadd{,
  }\bibinfo{pages}{367--374} \DIFadd{(}\bibinfo{year}{1994}\DIFadd{).
}

\bibitem{OdlingSmee2013b}
\bibinfo{author}{Odling-Smee, F.}\DIFadd{, }\bibinfo{author}{Laland, K.} \DIFadd{\&
  }\bibinfo{author}{Feldman, M.}
\newblock \emph{\bibinfo{title}{Niche Construction: The Neglected Process in
  Evolution}}\DIFadd{.
}\newblock \DIFadd{Monographs in Population Biology (}\bibinfo{publisher}{Princeton
  University Press}\DIFadd{, }\bibinfo{address}{Princeton, NJ}\DIFadd{, }\bibinfo{year}{2013}\DIFadd{).
}

\DIFaddend \bibitem{Kidwell1986}
...
\DIFaddbegin \bibitem{Cantor2017}
\bibinfo{author}{Cantor, M.} \emph{\DIFadd{et~al.}}
\newblock \bibinfo{title}{Nestedness across biological scales}\DIFadd{.
