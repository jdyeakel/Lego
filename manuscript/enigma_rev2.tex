...
\rev{We find that as we increase the frequency of service interactions (holding constant trophic interactions; see Appendix 2), the assembled community at steady state becomes more nested (Fig. \ref{fig:nest}).}
...
This stability can be observed by examining the exclusionary differences between species in a simple nested motif (Fig. \ref{fig:nest}, inset).
...
Because mutualisms increase dependencies between species, they also increase the frequency of secondary extinctions (Fig. \ref{fig:mutsecext}).
...
As such, measuring persistence in terms of the proportion of time species are established in the network reveals that more frequent mutualisms leads on average to lower persistence (Fig. \ref{fig:nest}a).
