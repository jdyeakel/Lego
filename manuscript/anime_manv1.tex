...
Here, species dependencies are low, such that primary extinctions due to predation will generally not result in a large number of secondary extinctions because the need threshold is not easily violated.
...
\begin{figure}
\centering
\includegraphics[width=0.375\textwidth]{fig_traj.pdf}
\caption{
...
\begin{figure}
\centering
\includegraphics[width=0.375\textwidth]{fig_taylors.pdf}
\caption{
...
\begin{figure}
\centering
\includegraphics[width=0.375\textwidth]{fig_sen_nn.pdf}
...
The numver of objects in the system at time $t$ (and by extension the number of engineers) is strongly positively correlated with the number of potential colonizers at time $t+1$.
