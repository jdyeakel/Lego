...
\caption{
\textbf{a}, Assembling communities over time from a pool of 200 engineering species. Species richness is blue; modifier richness is red.
...
The red dashed line shows the analytical expectation (Equation (\ref{eq:redundant})).
...
The red dashed line shows the analytical expectation of $\phi \approx 0.418$ (Equation (\ref{eq:redundantprop})).
Box edges define the 25th and 75th percentiles of simulation results, and whiskers represent $1.5\times$ the interquartile range.
}
